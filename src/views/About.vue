<template>
  <div class="about">
    <h1></h1>
    <img :src="require('../assets/how-hard-disk-drives-work-1.png')"/>
    <img :src="require('../assets/reading-writing-data-1.png')"/>
    <img :src="require('../assets/platters-spindle-1.png')"/>
    <img :src="require('../assets/case-1.png')"/>
